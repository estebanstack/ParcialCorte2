...
public class MiniCRUDLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "CREATE", "TABLE", 
			"INSERT", "INTO", "VALUES", "SELECT", "FROM", "WHERE", "UPDATE", "SET", 
			"DELETE", "AND", "OR", "NOT", "TRUE", "FALSE", "INT", "FLOAT", "TEXT", 
			"PRIMARY", "KEY", "EQ", "NEQ", "LE", "LT", "GE", "GT", "STAR", "ID", 
			"NUM", "STR", "WS", "LINE_CMT", "BLOCK_CMT"
		};
	}
	...
	public MiniCRUDLexer(CharStream input) {
		super(input);
